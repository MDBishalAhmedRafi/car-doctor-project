        ...
        <form onSubmit={handleBookService}>
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div className="form-control">
              ...
              <input defaultValue={data?.date} type="date" name="date" className="input input-bordered focus:outline-none focus:ring-2 focus:ring-orange-500" />
            </div>
            <div className="form-control">
              <label className="label">
          ...
          <div className="form-control mt-6">
            <input
              className="btn btn-outline border-1 border-orange-500 hover:bg-orange-500 hover:text-white btn-block"
              type="submit"
